...
class CDiT(nn.Module):
    ...
    def forward(self, x, t, y, x_cond, rel_t):
        ...
        y: (N,) tensor of class labels -- is this actions?
        """
        breakpoint()
        ...
        y = self.y_embedder(y) 
        time_emb = self.time_embedder(rel_t[..., None])  # this is the "timeshift" and it can be negative. I don't understand the utility of this
